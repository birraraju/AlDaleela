...
// import {UserActivityLog} from "../../../../Common/UserActivityLog";
// import { useTheme } from '../../../../Layout/ThemeContext/ThemeContext'; // Import the theme context
// import saveImageToIndexedDB from "../../../../../Providers/ProfileImageServices/SaveIndesDB";
// import GetImageFromIndexedDB from "../../../../../Providers/ProfileImageServices/GetProfileIndesDB";
...
//       localStorage.setItem("AldaleelaRole", data.data.role);
//       // localStorage.setItem("AldaleelaUserDetails:",JSON.stringify(data.data))
//       const { country, email, firstName, id, lastlogin, lastname, organization, phoneNumber, role, useractive, username } = data.data;
...
// // Store the destructured object in localStorage
// localStorage.setItem("AldaleelaUserDetails:", JSON.stringify(userDetails));
 
//  // Store image in IndexedDB
//  if (data.data.imageUrl) {
//   saveImageToIndexedDB("AldaleelaProfileImg", data.data.imageUrl);
// }

// // Retrieve image from IndexedDB (after saving)
