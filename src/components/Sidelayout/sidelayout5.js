...
export default function SideLayout5({
  ...
  return (
    <div
      ...
      // style={{ width, height }}
    >
      <div className={`relative sm:h-[74%] h-[98%]  sm:w-[80%] tab:w-full sm:float-none w-[99%] float-end rounded-2xl shadow-lg overflow-hidden border transition-colors duration-300 ${
          isDarkMode
