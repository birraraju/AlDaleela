...
export default function SideLayout5({
  ...
  return (
    <div
      ...
      className={`fixed top-16 w-[95%] sm:w-[400px] laptop_s:w-[${width}] h-[90%] sm:h-[68%] laptop_s:h-[90%] ${ isLangArab?"right-3 sm:left-16 laptop_s:left-3":"right-3 sm:right-16 laptop_s:right-3"} transition-transform duration-300 ease-in-out ${
      ...
      // style={{ width, height }}
    >
      <div className={`relative sm:h-[65%] h-[98%]  sm:w-[80%] tab:w-full sm:float-none w-[99%] float-end rounded-2xl shadow-lg overflow-hidden border transition-colors duration-300 ${
          isDarkMode
