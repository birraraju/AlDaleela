...
export default function SideLayout1({
  ...
  return (
    <div
      ...
      className={`fixed w-[90%] sm:w-[430px] laptop_s:w-[${width}] h-[90%] sm:h-[90%] top-16 ${ isLangArab?" right-3 sm:left-16 laptop_s:left-3":"right-3 sm:right-16 laptop_s:right-3"} transition-transform duration-300 ease-in-out ${
    ...
    >
     <div
  className={`relative sm:h-[80%] h-[98%] sm:w-full sm:float-none w-[100%] float-end rounded-2xl shadow-lg overflow-hidden border ${
    isDarkMode
