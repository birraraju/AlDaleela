...
export default function SideLayout6({
  ...
  return (
    ...
    >
      <div
        className={`relative sm:h-[65%] tab:h-[72%] tab_s:h-[56%] tab_m:h-[60%] tab_l_1:h-[65%]   h-[98%] sm:w-[80%] tab:w-full  w-full bg-opacity-70 float-end sm:float-none backdrop-blur-lg rounded-2xl shadow-lg overflow-hidden border ${
          isDarkMode
