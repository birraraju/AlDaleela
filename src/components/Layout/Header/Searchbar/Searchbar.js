    ...
    <div className={`mobile_s:mr-2 laptop_s:mr-0.5 ${SearchResponsive ? "grid" : "sm:grid hidden"} laptop_m:mr-2 mr-4`}>
      <div className="relative" ref={contentRef}>
        <Input
          ...
          className={`mobile_s:w-[22rem]   mobile_m:w-[23rem] mobile_l:w-[27rem] tab:w-[22rem]  tab_s:w-[24rem] tab_l:w-[26rem] tab_l_1:w-[28rem]  laptop_s:w-[18rem] laptop_m:w-[22rem] mobile_s:h-9 laptop_s:h-7 laptop_m:h-8  border-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0   pl-16 relative z-[2] ${
             isDarkMode
              ? "text-[#FFFFFFCC]"
