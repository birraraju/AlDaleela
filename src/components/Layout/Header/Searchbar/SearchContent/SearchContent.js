...
export default function SearchContent({ inputClicked, iscategory,setIscategory, inputValue, setInputValue, setInputClicked }) {
  ...
  return (
    <div
      className={`mobile_s:w-[18rem] mobile_m:w-[22rem] mobile_l:w-[22rem] tab:   ${(inputClicked || iscategory) ? "laptop_m:w-[27rem]" : "laptop_m:w-[30rem]"} rounded-2xl mb-8 absolute top-0 left-0 h-80 ${
