...
const Location = ({ isHeaderOpen,isLocationOpen }) => {
  ...
  } sm:flex hidden rounded-full z-40  mobile_s:h-9 laptop_m:h-8 mobile_s:w-9 laptop_m:w-8 mobile_s:mr-2 laptop_m:mr-2 justify-center items-center cursor-pointer`} 
  onClick={handleClick}
      >
        <img
