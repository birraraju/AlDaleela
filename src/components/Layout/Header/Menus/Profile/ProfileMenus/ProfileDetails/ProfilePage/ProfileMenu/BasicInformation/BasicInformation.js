              ...
              {isEditProfile ? (
                info.heading === "Country" ? (
                  <div className="relative">
                    ...
                    >
                      <span className="whitespace-nowrap overflow-hidden text-ellipsis sm:text-[13px] text-base">
                        {selectedCountry}
                      </span>
                      <span className="ml-2">
                        {/* Down arrow SVG */}
                  ...
                  <>
                    ...
                    />
                    {info.heading === "Email" && emailError && (
                      <p className="text-red-500 text-xs">{emailError}</p>
                    )}
                    {info.heading === "Phone Number" && phoneError && (
