    ...
    <div className={`fixed ${isLangArab ? "right-4" : "left-4"} ml-3 laptop_s:top-1/2 sm:top-64 sm:mt-2 laptop_s:mt-0 laptop_s:-translate-y-1/2 z-10 sm:flex hidden flex-col items-center space-y-2 bg-transparent p-2 rounded-full`}>
      ...
      <div className="w-12 text-white rounded-full flex flex-col items-center transition-colors duration-200">
        ...
        <button className="w-full h-8 my-10 flex items-center justify-center">
          ...
          <div className="absolute py-6 flex-1 justify-between">
            <button className="-translate-y-5 flex justify-center items-center" onClick={() => contextMapView.zoom += 1}>
              <img src={PlusSign} alt="Plus Sign" className="w-6" />
            </button>
            <img src={DashSign} alt="Dash Sign" className="w-6 -translate-y-2" />
            <button className="translate-y-2 p-1 flex justify-center items-center" onClick={() => contextMapView.zoom -= 1}>
              <img src={MinusSign} alt="Minus Sign" className="w-4" />
            </button>
          </div>
        </button>
      </div>
      ...
      {/* Left Arrow Button */}
      <button onClick={handlePreviousLevelClick} ref={zoomPrevBtn} className="w-12 h-12 text-white rounded-full flex items-center justify-center transition-colors duration-200">
