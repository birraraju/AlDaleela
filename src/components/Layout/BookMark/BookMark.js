...
const Popup1 = ({isDarkMode,isLangArab,BookMarkGreen,DarkBookMarkGreen,setIsManageVisible, isManageVisible,setIsSuccess,setisMsgStatus,setIsmodalMessage,onclose}) => {
  ...
  return (
    <div className="relative grid grid-cols-1 pt-2  h-full">
      <div className="grid grid-cols-3 justify-start   h-[81%] tab_s:h-[87%] laptop_s:h-[76%] overflow-y-auto items-start gap-y-4 gap-x-0">
