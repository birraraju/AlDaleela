...
const PrintComponent = ({ mapview }) => {
  ...
  return <div className=" sm:-mt-[500px] tab:-mt-[100%]  laptop_s:-mt-[365px] laptop_m:-mt-[365px] h-[400px] laptop_s:h-[350px] overflow-auto  -mt-[420px] Export" id="exportDiv" ref={exportRef} />;
